...
(defun init-distel ()
  ...
  (setq distel-path (concat (getenv "HOME") "/emacs/deps/distel-wrangler/elisp"))
...
(defun init-esense ()
  ...
  (add-to-list 'load-path "~/emacs/deps/esense")
  (require 'esense-start)
  (setq esense-indexer-program "~/emacs/deps/esense/esense.sh"))

(when (file-exists-p "~/emacs/deps/esense/esense.sh")
  (init-esense))
